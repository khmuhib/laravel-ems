...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.book.category.update', ['id'=>$book_category->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label>Book Category Name</label>
                    <input type="text" class="form-control" placeholder="Enter Book Category Name" name="name" value="{{$book_category->name}}">
                </div>
